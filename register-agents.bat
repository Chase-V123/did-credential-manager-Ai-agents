@echo off
REM Script to register DID Credential Manager agents with Nanda registry
REM Usage: register-agents.bat <base-url>
REM Example: register-agents.bat https://myagents.projectnanda.org
...
REM Register AI Agent (Summarization)
